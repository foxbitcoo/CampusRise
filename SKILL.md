...
6. Offer optional but useful slots once. Do not block generation if the user skips them:
   ...
   - `校园经历 / 社团经历`
   - `英文名 / 签名名`
7. Produce or use the final prompt template immediately after the optional-slot step. Load [references/prompt-templates.md](references/prompt-templates.md).
